...
//RSA
InoCal1Hit_Manager ::InoCal1Hit_Manager() {    APointer = this;  }
InoCal1Hit_Manager:: ~InoCal1Hit_Manager(){}
InoCal1Hit_Manager* InoCal1Hit_Manager::APointer;
...
CmvStrip_Manager ::CmvStrip_Manager() {    APointer = this;  }
CmvStrip_Manager:: ~CmvStrip_Manager(){}
CmvStrip_Manager *CmvStrip_Manager::APointer;

SipmHit_Manager ::SipmHit_Manager() {    APointer = this;  }
SipmHit_Manager:: ~SipmHit_Manager(){}
SipmHit_Manager *SipmHit_Manager::APointer;

CmvHit_Manager ::CmvHit_Manager() {    APointer = this;  }
CmvHit_Manager:: ~CmvHit_Manager(){}
CmvHit_Manager *CmvHit_Manager::APointer;




CmvCluster_Manager ::CmvCluster_Manager() {    APointer = this;  }
CmvCluster_Manager:: ~CmvCluster_Manager(){}
CmvCluster_Manager *CmvCluster_Manager::APointer;


CmvLayExtra_Manager ::CmvLayExtra_Manager() {    APointer = this;  }
CmvLayExtra_Manager:: ~CmvLayExtra_Manager(){}
CmvLayExtra_Manager *CmvLayExtra_Manager::APointer;
...
{    
  ...
  icalGeometry        = TGeoManager::Import(geoFiles); //valgrind RSA
