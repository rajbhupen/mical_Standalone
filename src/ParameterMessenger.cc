...
ParameterMessenger::ParameterMessenger() {
  AnPointer = this;
  cout<<"ParameterMessenger::ParameterMessenger() {"<<endl;
  SetDetectorType(1);
...
void ParameterMessenger::PrintParameters()
{
  cout<<"ParameterMessenger::PrintParameters()"<<endl;

  cout<<"InputOutput: "<<InputOutput<<" ";
  cout<<"TimeToDigi: "<<TimeToDigiConv<<" ";
  cout<<"CollatedIn: "<<CollatedIn<<" ";
  cout<<"CMVD: "<< CMVD<<" ";
  cout<<"Mag: "<<Magval<<" ";
