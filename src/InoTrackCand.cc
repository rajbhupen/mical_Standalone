...
InoTrackCand::InoTrackCand(InoTrack *trk, bool forward) :  fTrack(trk) {
  ...
  //  cout<<"InoTrackCand::InoTrackCand pos "<<trk->GetBegXPos()<<" "<<trk->GetBegYPos()<<" "<<this->GetVtxU()<<" "<<this->GetVtxV()<<endl;

  fVertex->SetDirCosine(tmp3v);
  //  cout <<"InoTrackCand::InoTrackCand dir "<<xdir<<" "<<ydir<<" "<<zdir<<endl;
  //  cout <<"InoTrackCand::InoTrackCand zdir "<<tmp3v->Z()<<" "<<fVertex->GetDirCosine().X()<<" "<<fVertex->GetDirCosine().Y()<<" "<<fVertex->GetDirCosine().Z()<<" "<<endl;
  //  cout <<"InoTrackCand::InoTrackCand dir "<<this->GetVtxDirCosU()<<" "<<this->GetVtxDirCosV()<<" "<<this->GetVtxDirCosZ()<<endl;
  //  cout <<"InoTrackCand::InoTrackCand cot"<<this->GetVtxDirCosU()/this->GetVtxDirCosZ()<<" "<<this->GetVtxDirCosV()/this->GetVtxDirCosZ()<<endl;
...
Double_t InoTrackCand::GetNewMomentum() const
{
  return fNewMomentum;
}

void InoTrackCand::SetNewMomentum(Double_t momentum)
{
  fNewMomentum = momentum;
}

Int_t InoTrackCand::GetNewFitOut() const
{
  return fNewFitOut;
}

void InoTrackCand::SetNewFitOut(Int_t momentum)
{
  fNewFitOut = momentum;
}
...
void InoTrackCand::SetExtPara(double * extra) {
	for (int ix=0; ix<6; ix++) {
		fExtPara[ix] = extra[ix];
	}
};
double InoTrackCand::GetExtPara(int ix) {
	return fExtPara[ix];
}
  //rsa

void InoTrackCand::SetRoofPara(double * extra) {
	for (int ix=0; ix<6; ix++) {
		fRoofPara[ix] = extra[ix];
	}
};
...
Int_t InoTrackCand::GetNPlane(Int_t iuv) const
{
  ...
  //  cout <<" iuv "<< iuv<<endl;
  if (iuv==2) { return ClustsInTrack.size(); }
  else {
    Int_t n=0;
...
//.........
void InoTrackCand::SetVtxUdUError(double error) {
  mVtxUdUError = error;
}

//----------------------------------------------------------------------
double InoTrackCand::GetVtxUdUError() const {
  return mVtxUdUError;
}
//..........

void InoTrackCand::SetVtxUdVError(double error) {
  mVtxUdVError = error;
}

//----------------------------------------------------------------------
double InoTrackCand::GetVtxUdVError() const {
  return mVtxUdVError;
}
//..........
void InoTrackCand::SetVtxVdVError(double error) {
  mVtxVdVError = error;
}

//----------------------------------------------------------------------
double InoTrackCand::GetVtxVdVError() const {
  return mVtxVdVError;
}


//.........
void InoTrackCand::SetVtxVdUError(double error) {
  mVtxVdUError = error;
}

//----------------------------------------------------------------------
double InoTrackCand::GetVtxVdUError() const {
  return mVtxVdUError;
}
...
void InoTrackCand::SetVtxdUdVError(double error)
{
  mVtxdUdVError = error;
}

//----------------------------------------------------------------------
double InoTrackCand::GetVtxdUdVError() const
{
  return mVtxdUdVError;
}
//RSA For kohlal code:
...
//----------------------------------------------------------------------
double InoTrackCand::GetPlaneStateVector(int iplane, int ijss) const {
  return mPlaneStateVector[iplane][ijss];
}

//----------------------------------------------------------------------
void InoTrackCand::SetPlaneStateVector(int iplane, int ijss, double values) {
  mPlaneStateVector[iplane][ijss] = values;
}

//----------------------------------------------------------------------
double InoTrackCand::GetPlaneCovMatrix(int iplane, int ijss, int jkss) const {
  return mPlaneCovMatrix[iplane][ijss][jkss];
}

//----------------------------------------------------------------------
void InoTrackCand::SetPlaneCovMatrix(int iplane, int ijss, int jkss, double values) {
  mPlaneCovMatrix[iplane][ijss][jkss] = values;
}
...
Double_t InoTrackCand::GetChi22() const {
  return mChi22;
}

void InoTrackCand::SetChi22(Double_t chi22) {
  mChi22 = chi22;
}
