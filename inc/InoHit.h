...
double GetXTimeCorr() const; // Returns Smeared Time of X strip with delay correctino (in ns) also with offset corr.
double GetYTimeCorr() const; // Returns Smeared Time of Y strip with delay correctino (in ns) also with offset corr.
